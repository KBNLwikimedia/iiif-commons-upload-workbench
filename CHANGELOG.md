...
- **Manifest thumbnail in the wizard header** — every step past input now shows the manifest's first-image thumbnail (44 px) at the top-left of the header, replacing the generic app icon, as a quick visual anchor for which manuscript is open alongside the "Short title — signature" line.
